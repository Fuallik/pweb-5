...
![Tampilan Desktop Light](asset/Documentation/lightmodepc.png)

2. Tampilan Desktop (Dark Mode)
![Tampilan Desktop Dark](asset/Documentation/darkmodepc.png)

3. Tampilan Mobile (Light Mode)
![Tampilan Mobile (Light Mode) 1 ](asset/Documentation/lightmodehp1.png)
![Tampilan Mobile (Light Mode) 2 ](asset/Documentation/lightmodehp2.png)
![Tampilan Mobile (Light Mode) 3 ](asset/Documentation/lightmodehp3.png)

5. Tampilan Mobile (Light Mode)
![Tampilan Mobile (Dark Mode) 1 ](asset/Documentation/darkmodehp1.png)
![Tampilan Mobile (Dark Mode) 2 ](asset/Documentation/darkmodehp2.png)
![Tampilan Mobile (Dark Mode) 3 ](asset/Documentation/darkmodehp3.png)
